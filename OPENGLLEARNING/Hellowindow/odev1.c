...
const char *fragmentShadeSource_orange = "#version 330 core\n"
    "out vec4 FragColor;\n"
    "void main()\n"
    "{\n"
...
const char *fragmentShadeSource_yellow = "#version 330 core\n"
    "out vec4 FragColor;\n"
    "void main()\n"
    "{\n"
...
int main(){
    ...
    glShaderSource(fragmentShader[0], 1, &fragmentShadeSource_orange, NULL);
    glCompileShader(fragmentShader[0]);

    glShaderSource(fragmentShader[1], 1, &fragmentShadeSource_yellow, NULL);
    ...
    glAttachShader(shaderProgramOrange,fragmentShader[0]);
    glLinkProgram(shaderProgramOrange);

    glAttachShader(shaderProgramYellow,vertexShader);
    glAttachShader(shaderProgramYellow,fragmentShader[1]);
